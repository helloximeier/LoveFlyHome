...
{
    /**注册单元格**/
    [self.orderTableView registerNib:[UINib nibWithNibName:@"LFHOrderCell" bundle:nil] forCellReuseIdentifier:@"orderCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    LFHOrderCell *orderCELL=[tableView dequeueReusableCellWithIdentifier:orderCell forIndexPath:indexPath];
