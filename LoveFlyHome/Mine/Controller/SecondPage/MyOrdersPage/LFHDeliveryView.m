...
#import "Masonry.h"
@interface LFHDeliveryView()<UITableViewDataSource,UITableViewDelegate>
@property(strong,nonatomic)UITableView *orderTableView;
@end
@implementation LFHDeliveryView

- (void)didMoveToSuperview
{
    /**注册单元格**/
       [self.orderTableView registerNib:[UINib nibWithNibName:@"LFHSendGoodsCell" bundle:nil] forCellReuseIdentifier:@"sendCell"];
    [self setTabView];
...
{
    static NSString *orderCell=@"sendCell";
    LFHSendGoodsCell *orderCELL=[tableView dequeueReusableCellWithIdentifier:orderCell];
