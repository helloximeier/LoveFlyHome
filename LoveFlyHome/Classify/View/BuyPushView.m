...
//    [_storeLabel setTextColor:[UIColor lineViewColor]];
    _storeLabel.text = @"剩余:1000件";
    [_storeLabel setFont:[UIFont fontWithName:@"Helvetica-Bold" size:14.0f]];
    [self addSubview:_storeLabel];
    
    //购买标准
    _haveSelect = [[UILabel alloc] initWithFrame:CGRectMake(15, 90, 120, 30)];
    _haveSelect.text = @"规格:1Kg";
    ...
    _buyNumField = [[UITextField alloc] initWithFrame:CGRectMake(self.frame.size.width - 91 + 13, 135, 40, 30)];
      _buyNumField.textAlignment = UITextAlignmentCenter;
    ...
    [_sureButton setFrame:CGRectMake(0, self.frame.size.height - 44, self.frame.size.width, 44)];
    [_sureButton setTitle:@"确定" forState:UIControlStateNormal];
    _sureButton.backgroundColor = [UIColor buyGoodsBackColor];
